...
import org.processmining.specpp.composition.composers.RelativeFitnessFilter;
...
public class EventingRelativeFitnessFilter<I extends CompositionComponent<Place>, R extends Result> extends RelativeFitnessFilter<I, R> {

    private final EventSupervision<CandidateCompositionEvent<Place>> composerEventSupervision = PipeWorks.eventSupervision();


    public EventingRelativeFitnessFilter(ComposerComponent<Place, I, R> childComposer) {
        super(childComposer);
