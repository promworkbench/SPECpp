...
import org.processmining.specpp.composition.composers.AggregatedFitnessFilter;
...
public class EventingAggregatedFitnessFilter<I extends CompositionComponent<Place>, R extends Result> extends AggregatedFitnessFilter<I, R> {

    private final EventSupervision<CandidateCompositionEvent<Place>> composerEventSupervision = PipeWorks.eventSupervision();


    public EventingAggregatedFitnessFilter(ComposerComponent<Place, I, R> childComposer) {
        super(childComposer);
